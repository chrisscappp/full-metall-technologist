...
pub struct CrimpingCalculationResult {
    ...
    pub result_coeff_of_crimping: f64,             // Итоговый коэф. обжима
...
pub fn crimping_excel_report(
	...
	sheet.get_cell_mut("F19").set_value(data.limit_coeff_of_crimping.to_string());
	sheet.get_cell_mut("F20").set_value(data.result_coeff_of_crimping.to_string());
	sheet.get_cell_mut("F21").set_value(data.degree_of_deformation.to_string());
	sheet.get_cell_mut("F22").set_value(data.operationsCount.to_string());

	let mut startIndexCrimpingCoeff = 23;
	let mut startIndexTechPower = 24;
	...
	for operation in data.operationsData.iter() {
		...
		sheet.get_cell_mut("F".to_string() + &(startOperationDataIndex + 2).to_string()).set_value(operation.angle_a.to_string());
		sheet.get_cell_mut("F".to_string() + &(startOperationDataIndex + 3).to_string()).set_value(operation.executive_diameter_of_matrix.to_string());
		sheet.get_cell_mut("F".to_string() + &(startOperationDataIndex + 4).to_string()).set_value(operation.allowance_for_wear_of_matrix.to_string());
		sheet.get_cell_mut("F".to_string() + &(startOperationDataIndex + 5).to_string()).set_value(operation.elastic_unloading.to_string());
		sheet.get_cell_mut("F".to_string() + &(startOperationDataIndex + 6).to_string()).set_value(operation.inaccuracy_tolerance.to_string());
		sheet.get_cell_mut("F".to_string() + &(startOperationDataIndex + 7).to_string()).set_value(operation.skat_height.to_string());
		sheet.get_cell_mut("F".to_string() + &(startOperationDataIndex + 8).to_string()).set_value(operation.circle_radius.to_string());
		sheet.get_cell_mut("F".to_string() + &(startOperationDataIndex + 9).to_string()).set_value(operation.diameter_of_crimping_rod.to_string());
